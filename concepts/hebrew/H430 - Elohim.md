...
The primary Hebrew designation for God, occurring 2,602 times in the Old Testament. A masculine plural noun used with singular verbs when referring to the God of Israel — the *pluralis majestatis* (plural of majesty).

## Morphology

- **Root**: אלה (*alah*) — to be strong, to swear
- **Form**: Plural (-ים) but governing singular verbs and adjectives when referring to YHWH
- **Related forms**: [[concepts/hebrew/H410 - El|אֵל]] (singular, "God/mighty one"), אֱלוֹהַּ (*Eloah*, singular poetic form)
...
The LXX renders אֱלֹהִים as [[concepts/greek/G2316 - theos|θεός]] (*theos*). John 1:1 — "the Word was [[concepts/greek/G2316 - theos|θεός]]" — deliberately echoes Genesis 1:1's opening, mapping the *logos* onto the creative Elohim.
